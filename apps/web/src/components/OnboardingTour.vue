...
function positionTooltip() {
  ...
  let top = 0; // eslint-disable-line no-useless-assignment -- reassigned in switch below
  let left = 0; // eslint-disable-line no-useless-assignment -- reassigned in switch below
